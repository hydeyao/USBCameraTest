...
QT_MOC_LITERAL(3, 19, 6), // "config"
QT_MOC_LITERAL(4, 26, 7), // "project"
QT_MOC_LITERAL(5, 34, 18), // "slt_config_changed"
QT_MOC_LITERAL(6, 53, 19), // "slt_project_changed"
QT_MOC_LITERAL(7, 73, 19) // "slt_saveBtn_pressed"

    },
    "ConfigWidget\0save\0\0config\0project\0"
    "slt_config_changed\0slt_project_changed\0"
    "slt_saveBtn_pressed"
};
...
void ConfigWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->slt_config_changed((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->slt_project_changed(); break;
        case 3: _t->slt_saveBtn_pressed(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ConfigWidget::*)(QString , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConfigWidget::save)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ConfigWidget::save(QString _t1, QString _t2)
{
